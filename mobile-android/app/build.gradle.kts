...
dependencies {
    ...
    // Client de synchronisation (T042) vers contracts/endpoint-sync-api.yaml.
    ...
    // org.tensorflow:tensorflow-lite — niveau 3 IA, incrément futur (research.md §3), pas encore ajouté.
